        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        html.Div(
                            "List of survey data loaded from Kobo. Click to open analysis editor."
                        ),
                        html.A(
                            "Open analysis editor",
                            id="open-analysis-editor",
                            href=f"http://127.0.0.1:{editor_port}/",
                            target="_blank",
                        ),
                    ],
                    width=6,
                ...
                dbc.Col(
                    [
                        html.Div(
                            "List of already analyzed demand data. Click to open analysis editor."
                        )
                    ],
                    width=6,
                ),
...
def open_analysis_editor(n_clicks):
    ...
    editor = DatatableEditor(
        datatables=display_tables_dict, port=editor_port, debug=True
    )
